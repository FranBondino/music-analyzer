...
**3. Prepare your own CSV file** with track names, artists, and optional Spotify IDs (e.g., tracks.csv) and place it in the data/ directory. Use the format: name,artist,spotify_id (Spotify ID is optional).
...
## Getting Started
**1. Create a tracks.csv file with your desired tracks (e.g., name,artist,spotify_id).**

**2. Run the script to download and analyze your tracks, then explore the output CSV and plot.**

**3. Customize the clustering (e.g., number of clusters) by modifying the script if needed.**
